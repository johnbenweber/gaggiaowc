...
float InScaleMin = 80;       // set the Y-Axis Min
float InScaleMax = 140;    // and Max for both
float OutScaleMin = 0;      // the top and 
float OutScaleMax = 2000;    // bottom trends
...
String outputFileName = "test.txt"; // if you'd like to output data to 
...
void setup()
{
  ...
  myPort = new Serial(this, "/dev/ttyACM0", 9600);                //   Communication with
